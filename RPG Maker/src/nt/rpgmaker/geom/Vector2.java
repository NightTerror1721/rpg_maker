 ...
 * @since 1.0.0
 */
public class Vector2 extends PSUserdata
{
    ...
    /* LPL Operators */
    @Override
    public final Vector2 plus(PSValue value)
    {
        if(value.isNumber())
        {
        ...
        return sum(value.toPSUserdata());
    }
    
    @Override
    public final Vector2 minus(PSValue value)
    {
        if(value.isNumber())
        {
            double n = value.toJavaDouble();
        ...
        return difference(value.toPSUserdata());
    }
    
    @Override
    public final Vector2 multiply(PSValue value)
    {
        if(value.isNumber())
        {
            double n = value.toJavaDouble();
        ...
        Vector2 v = value.toPSUserdata();
        return new Vector2(x * v.x, y * v.y);
    }
    
    @Override
    public final Vector2 divide(PSValue value)
    {
        if(value.isNumber())
        {
            double n = value.toJavaDouble();
    ...
    public final PSValue equals(PSValue value)
    {
        try
        {
            return equals(value.toPSUserdata()) ? TRUE : FALSE;
        }
        catch(PSCastException ex)
        {
            return FALSE;
        }
    }
    ...
    private static final PSValue GET_X = PSFunction.<Vector2>method(self -> {
                return valueOf(self.x);
            });
    
    private static final PSValue GET_Y = PSFunction.<Vector2>method(self -> {
                return valueOf(self.y);
            });
    
    private static final PSValue SET = PSFunction.<Vector2>voidMethod((self, arg0, arg1) -> {
                if(arg1 == UNDEFINED)
                    self.set(arg0.toPSUserdata());
                self.set(arg0.toJavaDouble(),arg1.toJavaDouble());
            });
    
    private static final PSValue DOT = PSFunction.<Vector2>method((self, arg0, arg1) -> {
                if(arg1 == UNDEFINED)
                    return valueOf(self.dot(arg0.toPSUserdata()));
                return valueOf(self.dot(arg0.toJavaDouble(),arg1.toJavaDouble()));
            });
    
    private static final PSValue CROSS = PSFunction.<Vector2>method((self, arg0, arg1) -> {
                if(arg1 == UNDEFINED)
                    return valueOf(self.cross(arg0.toPSUserdata()));
                return valueOf(self.cross(arg0.toJavaDouble(),arg1.toJavaDouble()));
            });
    
    private static final PSValue LENGTH = PSFunction.<Vector2>method(self -> {
                return valueOf(self.getMagnitude());
            });
    
    private static final PSValue LENGTH_SQ = PSFunction.<Vector2>method(self -> {
                return valueOf(self.getMagnitudeSquared());
            });
    
    private static final PSValue DIRECTION = PSFunction.<Vector2>method(self -> {
                return valueOf(self.getDirection());
            });
    
    private static final PSValue NORMALIZE = PSFunction.<Vector2>method(self -> {
                return self.getNormalized();
            });
    
    private static final PSValue NEGATE = PSFunction.<Vector2>method(self -> {
                return self.getNegative();
            });
    
    private static final PSValue ANGLE_BETWEEN = PSFunction.<Vector2>method((self, arg0) -> {
                return valueOf(self.getAngleBetween(arg0.toPSUserdata()));
            });
    
    private static final PSValue TO = PSFunction.<Vector2>method((self, arg0, arg1) -> {
                if(arg1 == UNDEFINED)
                    return self.to(arg0.toPSUserdata());
                return self.to(arg0.toJavaDouble(),arg1.toJavaDouble());
            });
    
    private static final PSValue ROTATE = PSFunction.<Vector2>varMethod((self, args) -> {
                switch(args.numberOfArguments())
                {
                    case 1:
                        return self.rotate(args.arg(0).toJavaDouble());
                    case 2:
                        return self.rotate(args.arg(0).toJavaDouble(),args.arg(1).toPSUserdata());
                    case 3:
                        self.rotate(args.arg(0).toJavaDouble(),args.arg(1).toJavaDouble(),args.arg(2).toJavaDouble());
                }
                throw new PSRuntimeException("Invalid number of arguments (Required 1, 2 or 3)");
            });
}
