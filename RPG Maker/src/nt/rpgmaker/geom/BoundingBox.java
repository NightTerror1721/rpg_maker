...
import nt.rpgmaker.engine.io.SerializableObject;
import nt.rpgmaker.engine.io.Serializer;
import nt.rpgmaker.engine.io.Unserializer;
...
public class BoundingBox implements SerializableObject
{
    ...
    @Override
    public void unserialize(Unserializer us) throws IOException
    {
        x0 = us.readDouble();
        y0 = us.readDouble();
        x1 = us.readDouble();
